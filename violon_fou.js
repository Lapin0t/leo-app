...
function getJSONviolon_fou() {
	return '{"name": "violon_fou","filename": "violon_fou.dsp","version": "2.20.2","compile_options": "-lang wasm -scal -ftz 2","library_list": ["/usr/share/faust/stdfaust.lib","/usr/share/faust/signals.lib","/usr/share/faust/physmodels.lib","/usr/share/faust/routes.lib","/usr/share/faust/maths.lib","/usr/share/faust/delays.lib","/usr/share/faust/filters.lib"],"include_pathnames": ["/usr/share/faust","/usr/local/share/faust","/usr/share/faust",".","/home/peio/projects/leo-app"],"size": 32936,"inputs": 0,"outputs": 1,"meta": [ { "delays.lib/name": "Faust Delay Library" },{ "delays.lib/version": "0.1" },{ "filename": "violon_fou.dsp" },{ "filters.lib/fir:author": "Julius O. Smith III" },{ "filters.lib/fir:copyright": "Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>" },{ "filters.lib/fir:license": "MIT-style STK-4.3 license" },{ "filters.lib/iir:author": "Julius O. Smith III" },{ "filters.lib/iir:copyright": "Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>" },{ "filters.lib/iir:license": "MIT-style STK-4.3 license" },{ "filters.lib/lowpass0_highpass1": "Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>" },{ "filters.lib/name": "Faust Filters Library" },{ "filters.lib/resonbp:author": "Julius O. Smith III" },{ "filters.lib/resonbp:copyright": "Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>" },{ "filters.lib/resonbp:license": "MIT-style STK-4.3 license" },{ "filters.lib/tf2:author": "Julius O. Smith III" },{ "filters.lib/tf2:copyright": "Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>" },{ "filters.lib/tf2:license": "MIT-style STK-4.3 license" },{ "filters.lib/tf2s:author": "Julius O. Smith III" },{ "filters.lib/tf2s:copyright": "Copyright (C) 2003-2019 by Julius O. Smith III <jos@ccrma.stanford.edu>" },{ "filters.lib/tf2s:license": "MIT-style STK-4.3 license" },{ "maths.lib/author": "GRAME" },{ "maths.lib/copyright": "GRAME" },{ "maths.lib/license": "LGPL with exception" },{ "maths.lib/name": "Faust Math Library" },{ "maths.lib/version": "2.1" },{ "name": "violon_fou" },{ "routes.lib/name": "Faust Signal Routing Library" },{ "routes.lib/version": "0.1" },{ "signals.lib/name": "Faust Signal Routing Library" },{ "signals.lib/version": "0.0" }],"ui": [ {"type": "vgroup","label": "violon_fou","items": [ {"type": "vslider","label": "length","address": "/violon_fou/length","index": 52,"init": 0.5,"min": 0,"max": 10,"step": 0.01},{"type": "vslider","label": "pos","address": "/violon_fou/pos","index": 40,"init": 0.5,"min": 0,"max": 1,"step": 0.01}]}]}';
}
/*
 faust2webaudio
...
// Usage : violon_fou.createDSP(audioCtx, 1024).then(dsp => dsp.connect(audioCtx.destination));
